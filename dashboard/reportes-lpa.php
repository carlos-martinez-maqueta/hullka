...
<html lang="es">
	...
	<body>
				...
				<div class="page-header">
					<div class="page-header-left d-flex align-items-center">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">Reportes LPA</li>
						</ul>
					</div>
						...
						<div class="col-lg-12">
                            <div class="card p-3">
                                <div class="row align-items-center p-2">
                                    <div class="col-6">
                                        <h3 class="m-0">Reportes LPA Socio</h3>
                                    </div>
                                    <div class="col-6 text-end">
                                        <button type="button" class="btn btn_add_edit btn-primary" data-bs-toggle="modal" data-bs-target="#modalAddReporte">
                                            Agregar
                                        </button>                                        
                                    </div>
                                </div>
                                ...
                                <hr>								
                                <div class="card-body">
                                    <h5 class="py-3">Reportes LPA</h5>
                                    <div class="table-responsive table-light shadow small-table p-3">
                                        <table class="table table-sm p-lg-4" id="reporte_lpa">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" scope="col">ID</th>
                                                    <th class="text-center" scope="col">Dni</th>
                                                    <th class="text-center" scope="col">Nombre Productor</th>
                                                    <th class="text-center" scope="col">Base Sectorial</th>
                                                    <th class="text-center" scope="col">Estimado Producción 2025</th>
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalAddReporte" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		...
		<div class="modal-dialog modal-xl"> <!-- usa modal-lg para más espacio -->
			<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5">Reporte Detallado</h1>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<form id="editReportForm">
				<input type="hidden" id="id_reporte_lpa" name="id_reporte_lpa">
				<div class="table-responsive">
					<table class="table table-bordered table-sm" id="detalleReporteTable">
					<thead>
						<tr>
						<th>Total Finca</th>
						<th>Cultivo Producción</th>
						<th>Cultivo Crecimiento</th>
						<th>Estimado Producción 2025</th>
						<th>Café Pergamino 2025</th>
						<th>Sub Producto 2025</th>
						<th>Acciones</th>
						</tr>
					</thead>
					<tbody>
				...
				<button type="button" class="btn btn-secondary my-2" id="addRowBtn">Añadir Fila</button>
				</form>
			</div>
			<div class="modal-footer">
        ...
        <script src="get/getReporteLpa.js"></script>    
		<script src="add/addReporteLpa.js"></script>
					...
					$.ajax({
						...
						success: function(response) {
							if (response.error) {
								...
								$('#nombre_productor').val(response.nombres + ' ' + response.apellidos);
								$('#base_sectorial').val(response.base_sectorial);
							}
						},
						error: function() {
