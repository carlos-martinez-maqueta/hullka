...
$(document).ready(function () {
  dataTable = $("#clasificacion_taza").DataTable({
    ordering: false,
    language: {
  ...
  getClasificacion(dataTable);

});

function getClasificacion(dataTable) {

  $.ajax({
    url: 'get/clasificacion_taza.php',
    method: 'POST',
    data: {
      action: 'get_clasificacion'
    },
    dataType: 'json',
    success: function (data) {
      ...
      $.each(data, function (index, result) {
        ...
        var newRow = '<tr>' +
          ...
          '<td class="align-middle text-center">' + result.marca + '</td>' +
          '<td class="align-middle text-center">' + result.puntaje + '</td>' +   
...
$(document).on("click", ".edit", function () {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $("#editarModal #id").val(data.id);
      $("#editarModal #marca").val(data.marca);
      $("#editarModal #puntaje").val(data.puntaje);
