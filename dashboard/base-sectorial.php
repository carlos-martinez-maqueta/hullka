	...
	<body>
				...
				<div class="page-header">
					<div class="page-header-left d-flex align-items-center">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">Base Sectorial</li>
						</ul>
					</div>
				...
				<div class="main-content">
					<div class="row">
						<div class="col-lg-12">
                            <div class="card ">
                                <div class="card-body">
                                    <h5 class="py-3">Base Sectorial</h5>
                                    <div class="table-responsive table-light shadow small-table p-3">
                                        <table class="table table-sm p-lg-4" id="base_sectorial">
                                            <thead>
                                                <tr>
		...
		<div class="modal-dialog">
			...
			<div class="modal-body">
				<form id="editBaseSectorialId">
					<input type="hidden" id="id" name="id">
					<div class="mb-3">
						<label class="form-label">Nombre Base Sectorial</label>
        ...
        <script src="get/baseSectorial.js"></script>
		<script src="edit/baseSectorialId.js"></script>         
	</body>
</html>
