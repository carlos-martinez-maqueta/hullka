	...
	<body>
				...
				<div class="page-header">
					<div class="page-header-left d-flex align-items-center">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">Datos Valores</li>
						</ul>
					</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-header">
				<h5 class="modal-title" id="modalEditLabel">Editar Registro</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
			</div>
			<div class="modal-body">
				<form id="editDatosActualizables">
					...
					<div class="mb-3">
						<label class="form-label">QQ Netos</label>
						<input type="text" class="form-control" id="qq_netos" name="qq_netos">
					</div>
					<div class="mb-3">
						<label class="form-label">Muestra General</label>
						<input type="text" class="form-control" id="muestra_general" name="muestra_general">
					</div>	
					<div>
        ...
        <script src="get/datosActualizables.js"></script>
		<script src="edit/datosActualizables.js"></script>         
	</body>
</html>
