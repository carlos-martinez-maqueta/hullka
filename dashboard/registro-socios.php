...
<html lang="es">
	...
	<body>
				...
				<div class="page-header">
					<div class="page-header-left d-flex align-items-center">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">Registro Socios</li>
						</ul>
					</div>
						...
						<div class="col-xxl-12">
							<div class="card p-3">
                                ...
                                <div class="table_socios">
                                    <div class="">
                                        <h5 class="pb-3">Listado Socios</h5>
                                        <div class="table-responsive table-light small-table">
                                            <table class="table table-sm" id="socios">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center" scope="col">NOMBRE DE ESPOSA</th>
                                                        <th class="text-center" scope="col">NÚMERO DE HIJOS</th>
                                                        <th class="text-center" scope="col">TELEFONO</th>
                                                        <th class="text-center" scope="col">DIRECCIÓN DE DNI</th>
                                                        <th class="text-center" scope="col">ESTATUS</th>
                                                        <th class="text-center" scope="col">BASE SECTORIAL</th>
                                                        <th class="text-center" scope="col">TIPO SELLO</th>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Agregar Socio</h1>
                        ...
                        <form id="addSocioForm">
                            <div class="row">
                                <div class="mb-3 col-4">
                                    ...
                                    <input type="text" class="form-control" id="" name="nombres" placeholder="Ingresa Nombres" required>
                                </div>
                                <div class="mb-3 col-4">
                                    <label for="" class="form-label">Apellidos</label>
                                    <input type="text" class="form-control" id="" name="apellidos" placeholder="Ingresa Apellidos" required>
                                </div> 
                                <div class="mb-3 col-4">
                                    <label for="" class="form-label">DNI</label>
                                    <input type="text" class="form-control" id="" name="dni" placeholder="Ingresa DNI" required>
                                </div>                                
                            </div>
                           <div class="row">
                                <div class="mb-3 col-4">
                                    <label for="" class="form-label">Fecha Nacimiento</label>
                                    <input type="date" class="form-control" id="" name="fecha_nacimiento" placeholder="" required>
                                </div>  
                                <div class="mb-3 col-4">
                                    <label for="" class="form-label">Nombre Esposa</label>
                                    <input type="text" class="form-control" id="" name="nombre_esposa" placeholder="Ingresa Nombre Esposa" required>
                                </div>
                                <div class="mb-3 col-4">
                                    <label for="" class="form-label">Número Hijos</label>
                                    <input type="text" class="form-control" id="numero_hijos" name="numero_hijos" placeholder="Ingresa Número de Hijos" required>
                                </div>                                                               
                           </div>     
                           <div class="row">
                                <div class="mb-3 col-4">
                                    <label for="" class="form-label">Teléfono</label>
                                    <input type="text" class="form-control" id="" name="telefono" placeholder="Ingresa tu Teléfono" required>
                                </div>
                                <div class="mb-3 col-4">
                                    <label for="" class="form-label">Dirección</label>
                                    <input type="text" class="form-control" id="" name="direccion" placeholder="Ingresa tu Dirección" required>
                                </div>      
                                <div class="mb-3 col-4">
                                    <label for="" class="form-label">Estatus</label>
									<select class="form-select form-control" name="estatus" required>
										<option value="">Selecciona Estatus</option>
										<?php foreach ($estatusadd as $estatu) { ?>
                           ...
                           <div class="row">
                                <div class="mb-3 col-4">
									...
									<select class="form-select form-control" name="base_sectorial" required>
										<option value="">Selecciona la Base Sect.</option>
										<?php foreach ($base_sectorial_select as $basesectorial) { ?>
											<option value="<?=$basesectorial->id?>"><?=$basesectorial->nombre_base;?></option>
										<?php } ?>
									</select>									
                                </div>     
                                <div class="mb-3 col-4">
                                    <label for="" class="form-label">Tipo de Certificación / Sello</label>
									<select class="form-select form-control" name="tipo_sello" required>
										<option value="">Selecciona el Tipo Sello</option>
										<?php foreach ($tipo_sello_select as $tipo_selloo) { ?>
											<option value="<?=$tipo_selloo->id?>"><?=$tipo_selloo->nombre_tipo;?></option>
										<?php } ?>
									</select>										
                                </div>                                                       
                           </div>      
							<!-- Contenedor para los hijos -->
							<div id="hijosContainer" class="row"></div>						                                                                                                   
        ...
        <script src="get/socios.js"></script>  
        <script src="add/addSocioForm.js"></script> 
		
		<script>
			$('#numero_hijos').on('input', function () {
			const cantidad = parseInt($(this).val()) || 0;
			const contenedor = $('#hijosContainer');
			contenedor.empty(); // Limpiar campos anteriores

			for (let i = 1; i <= cantidad; i++) {
				const html = `
				<div class="col-6 mb-2">
					<label for="nombre_hijo_${i}" class="form-label">Nombre Hijo ${i}</label>
					<input type="text" class="form-control" name="nombre_hijo[]" required>
				</div>
				<div class="col-6 mb-2">
					<label for="apellido_hijo_${i}" class="form-label">Apellido Hijo ${i}</label>
					<input type="text" class="form-control" name="apellido_hijo[]" required>
				</div>
				`;
