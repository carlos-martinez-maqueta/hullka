	...
	<body>
				...
				<div class="page-header">
					<div class="page-header-left d-flex align-items-center">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">Acopio Materia Prima</li>
						</ul>
					</div>
						...
						<div class="col-xxl-12">
							<div class="card p-3">
                                <div class="row align-items-center p-2">
                                    <div class="col-6">
                                        <h4 class="m-0">Acopio Materia Prima</h4>
                                    </div>
                                            ...
                                            <table class="table table-sm" id="acopio_materia_prima">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center" scope="col">HÚMEDAD</th>
		...
		<div class="modal fade" id="modalAddAcopio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-header">
					<h1 class="modal-title fs-5" id="exampleModalLabel">Agregar Acopio</h1>
				...
				<div class="modal-body">
					<form id="formAcopioSocio">
						...
						<div class="row">
							<div class="col-12">
								...
								<table>
									...
									<tbody>
										<tr>
											<td>RENDIMIENTO FISICO</td>
											<td><input type="number" id="fisico" name="rendimiento_fisico" value="" step="any"></td>
											<td><input type="text" id="porcentaje_fisico" name="porcentaje_rendimiento" readonly></td>
										</tr>
										<tr>
											<td>SEGUNDA</td>
											<td><input type="number" id="segunda" name="segunda" value="" step="any"></td>
											<td><input type="text" id="porcentaje_segunda" name="porcentaje_segunda" readonly></td>
										</tr>
										<tr>
											<td>DESCARTE</td>
											<td><input type="number" id="descarte" name="descarte" value="" step="any"></td>
											<td><input type="text" id="porcentaje_descarte" name="porcentaje_descarte" readonly></td>
										</tr>
										<tr>
											<td>CÁSCARA</td>
											<td><input type="text" id="cascara" name="cascara" readonly></td>
											<td><input type="text" id="porcentaje_cascara" name="porcentaje_cascara" readonly></td>
										</tr>
									</tbody>
								</table>								
							</div>					
						...
						<div class="row">
							<div class="col-lg-3">
								<div class="mb-3">
									<label for="" class="form-label">HÚMEDAD</label>
									<input type="text" class="form-control" id="humedad" name="humedad" placeholder="Agregar Húmedad">
								</div>
							</div>						
						</div>
		...
		<div class="modal fade" id="editarModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-body">
					<form id="editAcopioSocio">
						<input type="hidden" id="id" name="id">
						<div class="row">
							<div class="col-lg-4">
								<div class="mb-3">
									<label for="" class="form-label">DNI SOCIO</label>
									<input type="text" class="form-control" id="dni_edit" name="dni_socio" placeholder="Ingresa el DNI del Socio" readonly>
								</div>							
							</div>
							<div class="col-lg-4">
								<div class="mb-3">
									<label for="" class="form-label">PRODUCTOR</label>
									<input type="text" class="form-control" id="nombre_productor_edit" name="productor" readonly>
								</div>							
							</div>						
							<div class="col-lg-4">
								<div class="mb-3">
									<label for="" class="form-label">BASE SECTORIAL</label>
									<input type="text" class="form-control" id="base_edit" name="base_sectorial" readonly>
								</div>							
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-lg-3">
								<div class="mb-3">
									<label for="" class="form-label">CANTIDAD SACOS</label>
									<input type="text" class="form-control" id="cantidad_sacos_edit" name="cantida_sacos" placeholder="Cantidad de Sacos" readonly>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="mb-3">
									<label for="" class="form-label">KILOS BRUTOS</label>
									<input type="text" class="form-control" id="kilos_brutos_edit" name="kilos_brutos" placeholder="Kilos Brutos" readonly>
								</div>
							</div>		
							<div class="col-lg-2">
								<div class="mb-3">
									<label for="" class="form-label">TARA</label>
									<input type="text" class="form-control" id="tara_edit" name="tara" readonly>
								</div>
							</div>	
							<div class="col-lg-2">
								<div class="mb-3">
									<label for="" class="form-label">KILOS NETOS</label>
									<input type="text" class="form-control" id="kilos_netos_edit" name="kilos_netos" placeholder="Kilos Netos" readonly>
								</div>
							</div>
							<div class="col-lg-2">
								<div class="mb-3">
									<label for="" class="form-label">QQ NETOS</label>
									<input type="text" class="form-control" id="qq_netos_edit" name="qq_netos" readonly>
								</div>
							</div>												
						</div>
						<hr>
							...
							<div class="col-12">
								...
								<table>
									...
									<tbody>
										<tr>
											<td>RENDIMIENTO FISICO</td>
											<td><input type="number" id="fisico_edit" name="rendimiento_fisico" value="" step="any"></td>
											<td><input type="text" id="porcentaje_fisico_edit" name="porcentaje_rendimiento" readonly></td>
										</tr>
										<tr>
											<td>SEGUNDA</td>
											<td><input type="number" id="segunda_edit" name="segunda" value="" step="any"></td>
											<td><input type="text" id="porcentaje_segunda_edit" name="porcentaje_segunda" readonly></td>
										</tr>
										<tr>
											<td>DESCARTE</td>
											<td><input type="number" id="descarte_edit" name="descarte" value="" step="any"></td>
											<td><input type="text" id="porcentaje_descarte_edit" name="porcentaje_descarte" readonly></td>
										</tr>
										<tr>
											<td>CÁSCARA</td>
											<td><input type="text" id="cascara_edit" name="cascara" readonly></td>
											<td><input type="text" id="porcentaje_cascara_edit" name="porcentaje_cascara" readonly></td>
										</tr>
									</tbody>
								</table>								
							</div>					
        ...
        <script src="https://cdn.datatables.net/1.13.6/js/jquery.dataTables.js"></script>
         <script src="get/AcopioMateriaPrima.js"></script>  
		 <script>
  ...
  $('#dni_socio').on('blur', function() {
    ...
    if (dni !== "") {
      $.ajax({
		...
		<script>
			const muestraGeneral_edit = <?=$datosValores->muestraGeneral?>;

			const inputFisico_edit = document.getElementById('fisico_edit');
			const inputSegunda_edit = document.getElementById('segunda_edit');
			const inputDescarte_edit = document.getElementById('descarte_edit');

			const porcentajeFisico_edit = document.getElementById('porcentaje_fisico_edit');
			const porcentajeSegunda_edit = document.getElementById('porcentaje_segunda_edit');
			const porcentajeDescarte_edit = document.getElementById('porcentaje_descarte_edit');

			const inputCascara_edit = document.getElementById('cascara_edit');
			const porcentajeCascara_edit = document.getElementById('porcentaje_cascara_edit');
			...
			function actualizarTablaEdit() {
				const fisico_edit = parseFloat(inputFisico_edit.value) || 0;
				const segunda_edit = parseFloat(inputSegunda_edit.value) || 0;
				const descarte_edit = parseFloat(inputDescarte_edit.value) || 0;
				const cascara_edit = muestraGeneral_edit - fisico_edit - segunda_edit - descarte_edit;

				// Actualiza pesos
				inputCascara_edit.value = cascara_edit.toFixed(2);

				// Actualiza porcentajes
				porcentajeFisico_edit.value = formatearDecimal((fisico_edit * 100) / muestraGeneral_edit);
				porcentajeSegunda_edit.value = formatearDecimal((segunda_edit * 100) / muestraGeneral_edit);
				porcentajeDescarte_edit.value = formatearDecimal((descarte_edit * 100) / muestraGeneral_edit);
				porcentajeCascara_edit.value = formatearDecimal((cascara_edit * 100) / muestraGeneral_edit);

			}

			inputFisico_edit.addEventListener('input', actualizarTablaEdit);
			inputSegunda_edit.addEventListener('input', actualizarTablaEdit);
			inputDescarte_edit.addEventListener('input', actualizarTablaEdit);
		...
		<script src="edit/editAcopioSocio.js"></script> 
	</body>
</html>
