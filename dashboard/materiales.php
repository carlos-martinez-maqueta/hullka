...
<html lang="es">
	...
	<body>
                                ...
                                <div class="table_socios">
                                    <div class="">
                                        ...
                                        <div class="table-responsive table-light small-table">
                                            <table class="table table-sm" id="materiales">
                                                <thead>
						...
						<form id="addMateriales">
							<div class="row">
								...
								<div class="mb-3 col-4">
									...
									<input type="text" class="form-control" name="cantidad" placeholder="Ingresa Cantidad" required>
								</div>
							</div>
        ...
        <script src="get/materiales.js"></script>  
        <script src="add/addMateriales.js"></script>
	</body>
</html>
