...
<html lang="es">
	...
	<body>
				...
				<div class="page-header">
					<div class="page-header-left d-flex align-items-center">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">Clasificación Taza</li>
						</ul>
					</div>
						...
						<div class="col-xxl-12">
							<div class="card p-3">
                                <div class="row align-items-center p-2">
                                    <div class="col-6">
                                        <h3 class="m-0">Clasificación Taza</h3>
                                    </div>
                                    <div class="col-6 text-end">
                                        <button type="button" class="btn btn_add_edit btn-primary" data-bs-toggle="modal" data-bs-target="#modalAddClasifi">
                                ...
                                <div class="table_socios">
                                    <div class="">
                                        <h5 class="pb-3">Listado</h5>
                                        <div class="table-responsive table-light small-table">
                                            <table class="table table-sm" id="clasificacion_taza">
                                                <thead>
                                                        <th class="text-center" scope="col">ID</th>
                                                        <th class="text-center" scope="col">MARCA</th>
                                                        <th class="text-center" scope="col">RANGO DE PUNTAJE</th>
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalAddClasifi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						<form id="addClasificacion">
							<div class="row">

								<div class="mb-3 col-3">
									<label class="form-label">Marca</label>
									<input type="text" class="form-control" name="marca" placeholder="Ingresa Marca" required>
								</div>
								<div class="mb-3 col-3">
									<label class="form-label">Rango de Puntaje</label>
									<input type="text" class="form-control" name="puntaje" placeholder="Ingresa Puntaje" required>
								</div>
							</div>
		...
		<div class="modal fade" id="editarModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				...
				<div class="modal-body">
					<form id="editFormTaza">
						<div class="row">
							<input type="hidden" class="form-control" name="id_edit" id="id" >
							<div class="mb-3 col-6">
								<label class="form-label">Marca</label>
								<input type="text" class="form-control" name="marca_edit" id="marca" placeholder="Ingresa Marca" required>
							</div>
							<div class="mb-3 col-6">
								<label class="form-label">Rango de Puntaje</label>
								<input type="text" class="form-control" name="puntaje_edit" id="puntaje" placeholder="Ingresa Puntaje" required>
							</div>
						</div>
        ...
        <script src="get/clasificacion_taza.js"></script>  
        <script src="add/addClasificacion.js"></script>
		<script src="edit/editFormTaza.js"></script>
	</body>
</html>
